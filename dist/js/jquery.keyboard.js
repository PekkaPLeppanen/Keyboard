...
;(function (root, factory) {
    ...
    var $keyboard = $.keyboard = function (el, options) {
        ...
        base.startup = function () {
            ...
            // Create a modal
            base.$modal = base.modal.clone();
            base.$modal.insertBefore(base.$keyboard);
        ...
        base.makeTitle = function (title) {

            var $title = $('<div>').addClass('ui-keyboard-title').text(title);

            $title.prependTo(base.$keyboard);
        ...
        base.modal = $('<div>').addClass($keyboard.css.modal);
